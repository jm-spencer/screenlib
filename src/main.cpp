...
void opcontrol() {
  ...
  screen::HorBarMonitor mon4(scr);
    auto *ent3 = mon4.makeEntry()->
      withStyle(&tightBarStyle)->
      withBarHeight(50);
    auto *ent4 = mon4.makeEntry()->
      withStyle(&lv_style_pretty_color)->
      withBarHeight(30);
  ...
  while (true) {
    ...
    ent3->controllerSet(i);
    ent4->controllerSet(i * i * 0.01);
